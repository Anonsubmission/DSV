...
namespace DotNetOpenAuth.OAuth2.ChannelElements {
	...
	internal class TokenCodeSerializationBindingElement : AuthServerBindingElementBase {
		...
		/// </remarks>
        //shuo:begin
        public override MessageProtections? ProcessOutgoingMessage(IProtocolMessage message, CancellationToken cancellationToken) { return null; }
        //shuo:end
        ...
        //ERIC'S CODE
        public override MessageProtections? ProcessIncomingMessage(IProtocolMessage message, CancellationToken cancellationToken) { return null; }
