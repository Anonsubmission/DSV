...
namespace DotNetOpenAuth.OAuth2.ChannelElements {
	...
	internal abstract class AuthServerBindingElementBase : IChannelBindingElement {
		...
		/// </remarks>
        //shuo:begin
        public abstract MessageProtections? ProcessOutgoingMessage(IProtocolMessage message, CancellationToken cancellationToken);
        //shuo:end
		...
		/// </remarks>
        //ERIC'S CODE
        public abstract MessageProtections? ProcessIncomingMessage(IProtocolMessage message, CancellationToken cancellationToken);
