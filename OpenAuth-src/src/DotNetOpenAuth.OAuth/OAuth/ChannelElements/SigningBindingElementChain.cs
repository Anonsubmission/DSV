...
namespace DotNetOpenAuth.OAuth.ChannelElements {
	...
	internal class SigningBindingElementChain : ITamperProtectionChannelBindingElement {
        ...
        //shuo:begin
        public MessageProtections? ProcessOutgoingMessage(IProtocolMessage message, CancellationToken cancellationToken) { return null; }
        //shuo:end
		/// <summary>
		...
		/// </returns>
        //ERIC'S CODE
        public MessageProtections? ProcessIncomingMessage(IProtocolMessage message, CancellationToken cancellationToken) { return null; }
