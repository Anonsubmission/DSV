...
namespace DotNetOpenAuth.Messaging.Reflection {
    ...
    public class MessageDescriptionCollection : IEnumerable<MessageDescription>
    {
		...
		/// </summary>
        /// ERIC'S CODE
		public readonly Dictionary<MessageTypeAndVersion, MessageDescription> reflectedMessageTypes = new Dictionary<MessageTypeAndVersion, MessageDescription>();
        ...
        /// ERIC'S CODE
            ...
            public struct MessageTypeAndVersion
            {
			/// <summary>
