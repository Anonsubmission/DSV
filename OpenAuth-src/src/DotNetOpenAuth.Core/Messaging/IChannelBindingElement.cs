...
namespace DotNetOpenAuth.Messaging {
	...
	public interface IChannelBindingElement {
        ...
        //shuo:begin
        MessageProtections? ProcessOutgoingMessage(IProtocolMessage message, CancellationToken cancellationToken);
        //shuo:end
		/// <summary>
        ...
        /// 
        //ERIC'S CODE
        MessageProtections? ProcessIncomingMessage(IProtocolMessage message, CancellationToken cancellationToken);
