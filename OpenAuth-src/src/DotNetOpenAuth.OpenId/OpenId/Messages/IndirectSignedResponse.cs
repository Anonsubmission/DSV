...
//shuo:end
        ...
        public Uri ReturnTo
        {
            ...
            set
            {
                ...
                this._ReturnTo_Authority = this._ReturnTo.Authority;
                this._ReturnTo_Scheme = this._ReturnTo.Scheme;
                this._ReturnTo_AbsolutePath = this._ReturnTo.AbsolutePath;
            }
        }
        //shuo:end
