...
#pragma warning restore 0414
        ...
        public string _Recipient_Authority;
        public string _Recipient_Scheme;
        public string _Recipient_AbsolutePath;
        public Uri Recipient
        {
            ...
            set
            {
                ...
                this._Recipient_Authority = this._Recipient.Authority;
                this._Recipient_Scheme = this._Recipient.Scheme;
                this._Recipient_AbsolutePath = this._Recipient.AbsolutePath;
            }
        }
        ...
        {
            //public static string GetProtocolConstant(Version protocolVersion, Func<Protocol, string> mode)
            {
