...
namespace DotNetOpenAuth.OpenId {
	...
	public sealed class IdentifierDiscoveryResult : IProviderEndpoint {
        ...
        public IdentifierDiscoveryResult(ProviderEndpointDescription providerEndpoint, Identifier claimedIdentifier, Identifier userSuppliedIdentifier, Identifier providerLocalIdentifier, int? servicePriority, int? uriPriority)
        {
