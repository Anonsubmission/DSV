...
namespace DotNetOpenAuth.OpenId.RelyingParty {
    ...
    //ERIC'S CODE - begin
	public partial class OpenIdRelyingParty : IDisposable, IOpenIdHost {
    //ERIC'S CODE - end
		/// <summary>
        ...
        /// ERIC'S CODE
        public IEnumerable<IdentifierDiscoveryResult> Discover(Identifier identifier, CancellationToken cancellationToken){return null;}
        ...
        public Task<IEnumerable<IdentifierDiscoveryResult>> DiscoverAsync(Identifier identifier, CancellationToken cancellationToken)
        {
