...
namespace DotNetOpenAuth.OpenId.RelyingParty {
    ...
    //ERIC'S CODE
	//internal partial class PositiveAuthenticationResponse : PositiveAnonymousResponse {
    public partial class PositiveAuthenticationResponse : PositiveAnonymousResponse
    {
        ...
        public PositiveAuthenticationResponse(PositiveAssertionResponse response, OpenIdRelyingParty relyingParty)
			: base(response) {
        ...
        public IdentifierDiscoveryResult Endpoint { get; set; }
        ...
        public static async Task<PositiveAuthenticationResponse> CreateAsync(
