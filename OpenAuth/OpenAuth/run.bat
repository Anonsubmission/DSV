...
SET my_dir=C:\CCP\teamproject\OpenAuth\OpenAuth
SET STUB=stubs
...
call csc.exe /t:library /nowarn:108,436 /r:bin\Debug\DotNetOpenAuth.Core.dll;bin\Debug\DotNetOpenAuth.OpenId.dll;bin\Debug\DotNetOpenAuth.OpenId.RelyingParty.dll /debug /D:DEBUG stubs.cs
 
C:\Windows\Microsoft.NET\Framework64\v4.0.30319\MSBuild.exe OpenAuth.csproj
